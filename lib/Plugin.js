...
class Plugin {
  ...
  importMethod(methodName, file, pluginState) {
    if (!pluginState.selectedMethods[methodName]) {
      ...
      const path = winPath(this.customName ? this.customName(transformedMethodName, file) : (0, _path.join)(this.libraryName, libraryDirectory, transformedMethodName, this.fileName));
      pluginState.selectedMethods[methodName] = this.transformToDefaultImport ? (0, _helperModuleImports.addDefault)(file.path, path, {
        nameHint: methodName
